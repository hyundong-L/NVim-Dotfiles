...
return {
	{
		...
		config = function()
			...
			dashboard.section.buttons.val = {
				button("n", icons.newFile .. " " .. "New File", "<cmd>ene <BAR> startinsert<CR>", {}),
				button("f", icons.findFile .. " " .. "Find File", "<cmd>Telescope find_files<CR>", {}),
				...
				button("q", icons.exit .. " " .. "Exit", "<cmd>q<CR>", {}),
			}
